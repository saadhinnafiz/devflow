...
const questions = [
  {
    ...
    author: {
      _id: "1",
      name: "John Doe",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqJzlKriyaZ9VBxJm82ZqPAAuKUctTadEGdQWKSkLWcA&s",
    },
    upvotes: 10,
    answers: 5,
    views: 100,
  ...
  },
  {
    ...
    author: {
      _id: "2",
      name: "Jane Doe",
      image: "https://static.wikia.nocookie.net/4f01fc1b-7a8b-47d7-b6dd-9101cd95a546/scale-to-width/755",
    },
    upvotes: 8,
    answers: 3,
    views: 50,
  ...
  },
  {
    ...
    author: {
      ...
      name: "Alice Doe",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTROkDkvRRYhwKtLma-CozcDarsowshOFkSpPUEESVv8wxZo7HW7rNAwnd&s=10",
    },
    upvotes: 5,
    answers: 2,
    views: 30,
